...
public class Calculn2_2 extends Activity implements OnClickListener {
	TextView calcul;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(cpt==3){
			Intent CalculResultat = new Intent(this,Calculn2_Resultat.class);
		...
		if (v == calculer) {
			   ...
			   if(valTappe.equals(""))
			   {
				...
				Toast toast1 = Toast.makeText(getApplicationContext(),
						"Bonne r�ponse !!", Toast.LENGTH_SHORT);
				toast1.show();
				cpt++;
